...
path_prefix = os.path.dirname(__file__) + "/scripts"

class path_finding(object):
    def __init__(self):
    ...
    def put_debug_overlay(self):
        ...
        cv2.putText(self.last_image, f'goal id: xxx', (ox, oy+18), cv2.FONT_HERSHEY_SIMPLEX, 0.5, color,  1)
        cv2.putText(self.last_image, f'goal color: xxx', (ox, oy+36), cv2.FONT_HERSHEY_SIMPLEX, 0.5, color,  1)
        cv2.putText(self.last_image, f'holding: xxx', (ox, oy+54), cv2.FONT_HERSHEY_SIMPLEX, 0.5, color,  1)
    ...
    def image_callback(self, msg):
        ...
        #need to implement the middle of the color 
